...
### Paleta
- Fundo principal (brand blue): PANTONE 2188 C (CMYK C100 M80 Y20 K40)  
  - Use um HEX web aproximado (definir em CSS como `--brand-blue`), mantendo leitura “azul petróleo profundo / quase preto”.
- Dourado (brand gold): PANTONE 871 C (CMYK M20 Y60 K20)  
  - Use um HEX web aproximado em `--brand-gold` (tom de “ouro fosco / ouro velho”, sem saturação).
...
## 2) Posicionamento (o que o paciente entende em 10s)
### Frase-mãe (draft editável)
...
- Entender o “como” (explicação técnica acessível)
- Processo (planejamento e acompanhamento)
- Atendimento premium (experiência sem fricção)

### “Não é para”
- Quem busca “promoção”, “cirurgia rápida”, “milagre”
- Quem não aceita que casos complexos exigem planejamento e critérios
- Quem quer decidir “por impulso” sem avaliação técnica

---

## 4) Procedimentos foco (ordem de prioridade)
### Linha 1 — Cirurgias Mamárias (principal)
- Aumento de mama (quando bem indicado)
...
- “Olhar cirúrgico” (blefaroplastia estruturada / ptose), como procedimento de entrada que pode elevar LTV.
  (Só citar se fizer sentido comercial agora; senão omitir.)

---

## 5) Oferta e Funil (MUC)
### Conversão principal
...
### WhatsApp oficial
- Número: (11) 95251-6867
- Internacional: 5511952516867
...
- Texto com foco em previsibilidade, critérios e acompanhamento
...
## 10) Restrições de estilo (para manter coerência premium)
- Sem frameworks pesados; página leve e rápida.
- Sem excesso de seções; texto curto; layout com respiro.
- Nada “guru”; nada de contagem regressiva; nada de “promoção”.
- “Apple meets Medicine”: minimalismo, precisão, silêncio.
